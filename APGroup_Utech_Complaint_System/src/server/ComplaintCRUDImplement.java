...
public class ComplaintCRUDImplement implements ComplaintCRUD {
    ...
    public boolean addComplaint(Complaint complaint) {
        String query = "INSERT INTO complaint (complaint_id, student_id, advisor_id, category, description, status, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";

        try (Connection connection = dataSource.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(query)) {

            preparedStatement.setInt(1, complaint.getComplaintId());
            preparedStatement.setString(2, complaint.getStudentId());
            preparedStatement.setString(3, complaint.getStaffId());
            preparedStatement.setString(4, complaint.getCategory());
            preparedStatement.setString(5, complaint.getDescription());
            preparedStatement.setString(6, complaint.getStatus());
            preparedStatement.setTimestamp(7, new java.sql.Timestamp(complaint.getCreateAt().getTime()));
            preparedStatement.setTimestamp(8, new java.sql.Timestamp(complaint.getUpdatedAt().getTime()));
